...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            value=['Yearly Statistics', 'Recession Period Statistics'],
    ...
    html.Div(dcc.Dropdown(
            ...
            value=[{'label': i, 'value': i} for i in year_list],
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        exp_rec= recession_data.groupby("Vehicle_Type")['Automobile_Sales'].mean()
        R_chart3 = dcc.Graph(
                    figure=px.pie(exp_rec,
                    values=exp_rec.index,
                    names=exp_rec.names,
...
# Plot 2 Total Monthly Automobile sales using line chart.
	...
	# Hint:Use the columns Month and Automobile_Sales.
        mas=data.groupby('Month')['Automobile_Sales'].mean()
  ...
  # Plot bar chart for average number of vehicles sold during the given year
        ...
        Y_chart3 = dcc.Graph( figure(10, 6),title='Average Vehicles Sold by Vehicle Type in the year {}'.format(input_year)))
